...
Status: **draft** (2026-08-07). Successor to the interim OOM mitigations in `specs/rides-v5.md` §"Footer pathology"; supersedes the `rg_size: 16384` rebuild plan proposed there (shelved — see §Why not just bigger row groups).
